        ...
        <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
					<?php while ( have_posts() ) : the_post(); ?>
						...
						<?php
						$post_pagination_enable = get_theme_mod( 'kyamera_enable_single_page_pagination', true );
						if ( $post_pagination_enable ) {
							the_post_navigation( array(
									'prev_text'          => kyamera_get_svg( array( 'icon' => 'left-arrow' ) ) . '<span>%title</span>',
									'next_text'          => '<span>%title</span>' . kyamera_get_svg( array( 'icon' => 'left-arrow' ) ),
								) );
						}
						$single_comment_enable = get_theme_mod( 'kyamera_enable_single_comment', true );
