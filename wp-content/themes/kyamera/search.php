		    ...
		    <div class="wrapper">
		        <header class="page-header">
		            <h1 class="page-title"><?php
						...
						printf( esc_html__( 'Search Results for: %s', 'kyamera' ), '<span>' . get_search_query() . '</span>' );
					?></h1>
		        </header>
		        <?php  
    	...
    	<div id="inner-content-wrapper" class="wrapper page-section">
			<div id="primary" class="content-area">
                <main id="main" class="site-main" role="main">
    	        	...
    	        	?>
                    <div class="blog-posts-wrapper col-<?php echo esc_attr( $col );?>">
                    	<div id="kyamera-infinite-scroll" class="blog-archive-wrapper">
